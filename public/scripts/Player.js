...
export default class Player{
    ...
    shoot(){
        if(this.mousePressed && !this.onCooldown){ //also check if cooldown timer is zero
            //create bullet
            const newPositionOffset = checks.getDirection(this.x, this.y, this.mouseX, this.mouseY, this.bulletSpeed);
            let bullet = new Bullet(this.x,this.y,this.bulletHeight, this.bulletWidth, this.dmg, this.bulletSpeed, newPositionOffset[0], newPositionOffset[1],'yellow');
